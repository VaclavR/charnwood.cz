...
const galleryImages = [
    '/images/projects/westpoint/1.jpg',
    '/images/projects/westpoint/2.jpg',
    '/images/projects/westpoint/3.jpg',
    '/images/projects/westpoint/4.jpg'
]

export default function PageClient({lang}) {
    const headerData = {
        titleTop: `${t('prague', lang)}`,
        titleBottom: 'WESTPOINT PARK',
        images: ['/images/projects/westpoint/main.jpg']
    }
    ...
    return (
        <main className='mt-60 md:mt-120 w-1440 max-w-full mx-auto'>
                ...
                <div className='mt-4 md:mt-0 flex flex-col overflow-hidden'>
                    <div className='flex'>
                        <Image
                            ...
                            src='/images/projects/westpoint/1.jpg'
                            alt='building'
                            width={700}
                            height={300}
                            onClick={() => openModal(0)}
                        ...
                        <div className='flex flex-col md:flex-row md:items-center'>
                            <div className='w-full md:w-auto'>
                                <Image
                                    ...
                                    src='/images/projects/westpoint/2.jpg'
                                    alt='building'
                                    width={600}
                                    height={300}
                                    onClick={() => openModal(1)}
                            ...
                            <div className='w-full md:w-auto'>
                                <Image
                                    ...
                                    src='/images/projects/westpoint/3.jpg'
                                    alt='building'
                                    width={600}
                                    height={300}
                                    onClick={() => openModal(2)}
                    ...
                    <div className='flex'>
                        <Image
                            className='flex-1 w-auto min-h-[270px] max-h-[270px] cursor-pointer object-cover'
                            src='/images/projects/westpoint/4.jpg'
                            alt='building'
                            width={700}
                            height={300}
                            onClick={() => openModal(3)}
            ...
            <section className={sectionClasses}>
                ...
                <Location
                    image='/images/projects/westpoint/map.jpg'
                    locationText={`U Silnice 949/11<br>161 00 ${t('prague', lang)} 6<br>Ruzyně`}
                    locationLink='https://goo.gl/maps/8jKZD38SZW8HuPap8'
                />
            </section>
